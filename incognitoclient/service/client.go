...
type IncognitoInterface interface {
	Post() error
...
func (i *Incognito) PostAndReceiveInterface(method string, params interface{}) (interface{}, []byte, error) {
...
func (i *Incognito) Post(method string, params interface{}) ([]byte, error) {
...
func (i *Incognito) buildParameter(method string, params interface{}) *Parameter {
	payload := &Parameter{
		JsonRpc: "1.0",
		Method:  method,
		Params:  params,
